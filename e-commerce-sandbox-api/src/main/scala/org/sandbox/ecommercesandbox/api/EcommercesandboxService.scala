package org.sandbox.ecommercesandbox.api
...
object EcommercesandboxService  {
  val TOPIC_NAME = "greetings"
}

/**
  * The e-commerce-sandbox service interface.
  * <p>
  * This describes everything that Lagom needs to know about how to serve and
  * consume the EcommercesandboxService.
  */
trait EcommercesandboxService extends Service {
  ...
  override final def descriptor = {
    import Service._
    // @formatter:off
    named("e-commerce-sandbox")
      .withCalls(
        pathCall("/api/hello/:id", hello _),
        pathCall("/api/hello/:id", useGreeting _)
      )
      .withTopics(
        topic(EcommercesandboxService.TOPIC_NAME, greetingsTopic)
